...
public class Validadores {
     ...
     * @return true si el número de serie es numérico y tiene una longitud
     * máxima de 17 caracteres, false en caso contrario.
     */
     ...
     * @return true si el RFC cumple con el formato alfanumérico, false en caso
     * contrario.
     */
    ...
    /**
     * Metodo para validar la placa como input
     * @param placa Placa a validar
     * @return true si es correcto, false si no
     */
    public boolean validarFormatoPlaca(String placa) {
        String regex = "[A-Z]{3}-\\d{3}"; // Expresión regular para validar el formato de la placa
        return placa.matches(regex); // Verifica si la placa cumple con la expresión regular
    }
